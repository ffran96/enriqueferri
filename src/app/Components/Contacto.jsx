      ...
      <article className="mb-5 pt-20 flex flex-col xl:flex-row gap-10 justify-center items-center">
        ...
        {submitted ? (
          ...
          <form
            ...
            className="flex flex-col gap-3 text-[#000000] w-full lg:w-[600px] xl:w-[360px] [&>input]:rounded-[12px] [&>input]:text-xl [&>input]:h-12 [&>input]:p-4 [&>textarea]:h-52 [&>input]:placeholder-[#dcd9d1] [&>input]:text-[#dcd9d1] [&>textarea]:p-4 [&>textarea]:text-xl [&>textarea]:rounded-[12px] [&>textarea]:placeholder-[#dcd9d1] [&>textarea]:text-[#dcd9d1]"
          >
            <input
              id="name"
              type="text"
