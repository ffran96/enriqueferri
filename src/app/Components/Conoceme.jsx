      ...
      <article className="pt-20 flex flex-col xl:flex-row items-center justify-between gap-10">
        <div className="max-w-[600px] [&>p]:mb-4 [&>p]:leading-6 xl[&>p]:leading-[30px] [&>p]:text-lg md:[&>p]:text-2xl [&>p]:text-pretty">
          ...
          <p>
            ...
            realización de videoclips, combinando recursos visuales, efectos
            dinámicos y una estética cuidada para crear experiencias que
            impacten y conecten.
          </p>
          <p>
            ...
            géneros, buscando capturar la esencia de su música a través de una
